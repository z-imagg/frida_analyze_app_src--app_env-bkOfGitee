...
source /fridaAnlzAp/app_bld/linux5/docker_instance.sh
...
1.2. 编译linux:
  bash -x /fridaAnlzAp/app_bld/linux5/busz/linux_x86_64__build.sh
...
1.4. 以busybox制作initramfs:
  bash -x /fridaAnlzAp/app_bld/linux5/busz/initRamFs_create.sh
